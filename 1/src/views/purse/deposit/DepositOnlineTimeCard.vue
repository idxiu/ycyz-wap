        ...
        <div class="content">
            ...
            <div class="choose-money">
                <div class="sys-money remark pk-1px-b">
                    ...
                    <input name="cardType" @click="popupVisible = true" v-validate="'required'" readonly v-model="postData.chooseCard"
                        type="text" placeholder="请选择点卡类型">
                ...
                <div class="sys-money remark pk-1px-b">
                    ...
                    <input name="password" type="password" v-model="postData.password" v-validate="'required'"
                        placeholder="请输入您的点卡密码">
                ...
                <div class="sys-money remark pk-1px-b">
                    ...
                    <input name="money" type="number" v-model="postData.money" v-validate="'required|numeric'"
                        placeholder="请输入您的点卡金额">
            ...
            <div class="error-hint">
                ...
                <span v-show="!errors.has('cardType') && !errors.has('serialNumber') && errors.has('password')">{{
                    errors.first('password') }}</span>
                <span v-show="!errors.has('cardType') && !errors.has('serialNumber') && !errors.has('password') && errors.has('money')">{{
                    errors.first('money') }}</span>
            </div>
            <div class="submit">
...
<script>
    ...
    // import deposits from '../../../proto/member_deposit_pb'
    // const deposits = proto.pb;
    export default {
        name: 'timeCard',
        components: {
            Header
