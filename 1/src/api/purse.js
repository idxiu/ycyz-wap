...
function getAuditInfo() {
    return request('PURSE_AUDIT', null, 'pb.AppAuditResp');
}
...
function postWithdraw(req) {
    ...
    return request('PURSE_WITHDRAW_OUT', data, 'pb.AppAuditResp');
}
...
//额度转换模式切换
function postTransferModeChange (req) {
    const data = request.create('pb.SetMemberFreeWalletSwitchReq', req);
    return request('PURSE_CONVERSION_MODE_CHANGE', data, 'pb.OrderResp');
}
