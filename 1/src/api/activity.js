...
export function getTurntableLogin() {
    return request('TURNTABLE_SHOW_LOGIN', null, "pb.TurnTableOneResp")
}
...
//活动领取记录
export function getActivityRecord(req) {
    const data = request.create('pb.ActivityLogReq', req)
    return request('GET_ACTIVITY_RECORD', data, "pb.ActivityLogResp")
}
