export default {
    ...
    //及时稽核查询   path: "/auditQuery",
    PURSE_AUDIT: "/withdrawFee", //及时稽核查询

    //代理申请  path: "/agencyappli",
