<template>
	<div class="widthdraw-audit">
		...
		<div class="content" v-if="queryData">
			<div class="audit-details" style="margin-top:0">
				<ul>
					<li>
						<span>取款金额</span>
					...
					<li class="pk-1px-tb">
						...
						<span class="num red" v-if="adminMoneyNum>0"> <span style="color:#333;">扣除行政费</span>{{adminMoneyNum}}</span>
						<span class="num green" v-if="adminMoneyNum<=0"> <span style="color:#333;">扣除行政费</span>{{adminMoneyNum}}</span>
					</li>
					<li class="pk-1px-tb">
						<span>
						...
						<span class="num red" v-if="depositMoney>0"><span style="color:#333;">扣除优惠</span>{{depositMoney}}</span>
						<span class="num green" v-if="depositMoney<=0"><span style="color:#333;">扣除优惠</span>{{depositMoney}}</span>
					</li>
					<li class="pk-1px-tb">
						<span>扣除手续费</span>
