 ...
 * @Author: your name
 * @Date: 2019-10-09 16:42:05
 * @LastEditTime: 2019-10-09 16:59:15
	...
	<div class="my">
		...
		<div class="bgfff mgt-8">
			<router-link tag="div" class="avatar-tit" to="/about">
				<div class="avatar">
					<i v-if="!userinfo.photo">
						<img src="../../assets/img/morentouxiang.png" />
					</i>
					<i v-if="userinfo.photo">
			...
			<div class="money-wrap">
				<div class="money-s">
					...
					<div class="changer">
						<router-link tag="i" class="icon-changer" to="/transfer">
							<img src="../../assets/img/my-icon/icons/icon_mine_moneychange.png" />
						</router-link>
					</div>
					...
					<div class="refresh" @click="getMyInfo(1)">
						<i class="icon-refreshs">
							<img src="../../assets/img/my-icon/icons/icon_mine_refresh.png" />
						</i>
					</div>
				</div>
			</div>
		...
		<div class="tab-card">
			<ul class="tabs">
				<router-link tag="li" to="/deposit">
					<div class="icon-left">
						<i>
							<img src="../../assets/img/my-icon/icons/icon_mine_cz.png" />
						</i>
					</div>
				...
				<router-link tag="li" to="/withdraw">
					<div class="icon-left">
						<i>
							<img src="../../assets/img/my-icon/icons/icon_mine_tx.png" />
						</i>
					</div>
				...
				<router-link tag="li" to="/bankCard">
					<div class="icon-left">
						<i>
							<img src="../../assets/img/my-icon/icons/icon_mine_bankcard.png" />
						</i>
					</div>
				...
				<router-link tag="li" to="/intergral">
					<div class="icon-left">
						<i>
							<img src="../../assets/img/my-icon/icons/icon_mine_vip.png" />
						</i>
					</div>
				...
				<router-link tag="li" to="/betInformation">
					<div class="icon-left">
						<i>
							<img src="../../assets/img/my-icon/icons/icon_mine_tzzx.png" />
						</i>
					</div>
		...
		<ul class="tabs">
			<router-link tag="li" to="/transfer">
				<div class="icon-left">
					<i>
						<img src="../../assets/img/my-icon/icons/icon_mine_edzh.png" />
					</i>
				</div>
			...
			<router-link tag="li" to="/auditQuery">
				<div class="icon-left">
					<i>
						<img src="../../assets/img/my-icon/icons/icon_mine_jsjhcx.png" />
					</i>
				</div>
			...
			<router-link tag="li" to="/backwater" v-show="switchList.isWaterSelf">
				<div class="icon-left">
					<i>
						<img src="../../assets/img/my-icon/icons/icon_mine_zzfs.png" />
					</i>
				</div>
			...
			<router-link tag="li" to="/spread" v-show="switchList.isSpread">
				<div class="icon-left">
					<i>
						<img src="../../assets/img/my-icon/icons/icon_mine_wytg.png" />
					</i>
				</div>
		...
		<div class="bgfff bgf">
			<ul class="tabs">
				<router-link tag="li" :to="{name:'betRecord'}">
					<div class="icon-left">
						<i>
							<img src="../../assets/img/my-icon/icons/icon_mine_tzjl.png" />
						</i>
					</div>
				...
				<router-link tag="li" :to="{name:'depositRecord'}">
					<div class="icon-left">
						<i>
							<img src="../../assets/img/my-icon/icons/icon_mine_czjl.png" />
						</i>
					</div>
				...
				<router-link tag="li" :to="{name:'withdrawRecord'}">
					<div class="icon-left">
						<i>
							<img src="../../assets/img/my-icon/icons/icon_mine_txjl.png" />
						</i>
					</div>
				...
				<router-link tag="li" :to="{name:'transferRecord'}">
					<div class="icon-left">
						<i>
							<img src="../../assets/img/my-icon/icons/icon_mine_edzhjl.png" />
						</i>
					</div>
				...
				<router-link tag="li" :to="{name:'capitalRecord'}">
					<div class="icon-left">
						<i>
							<img src="../../assets/img/my-icon/icons/icon_mine_zjls.png" />
						</i>
					</div>
...
export default {
	...
	beforeRouteLeave(to, from, next) {
		...
		//不是试玩才能进入后面的页面
		console.log(to);
		if (to.name === "games" || to.name === "register") {
			next();
		} else {
			let isDemo = localStorage.getItem("isDemo") * 1;
			if (isDemo === 1) {
				//弹框
...
.avatar-tit {
	...
	i {
		img {
			width: 100%;
			height: 100%;
			box-shadow: 0px px2rem(3) px2rem(6) 0px rgba(0, 0, 0, 0.1);
			border-radius: 50%;
		}
	}
}
