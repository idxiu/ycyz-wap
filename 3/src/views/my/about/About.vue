 ...
 * @LastEditTime: 2019-10-10 09:40:42
...
<template>
    <div class="about">
            ...
            <div class="pk-form-content">
                <div class="bgf mgt24">
                    <div class="pk-input avatar">
                        <label>头像</label>
                        <img v-if="user.photo" class="icon-img" :src="user.photo" />
                        <img class="icon-img" v-if="!user.photo" src="../../../assets/img/morentouxiang.png" alt="">
                        <input type="file" name="headerImg" id="headerImg" @change="handleSendFile">
                    </div>
                </div>
                    ...
                    <div class="pk-input not-line">
                        ...
                        <nut-col :span="16" class="pk-foricon">
                            <div class="flex-content el-input">
                                <!-- :disabled="realNames!=''" -->
                                <input disabled class="inputs" type="text" v-model="user.realName" />
                            </div>
                        </nut-col>
                    </div>
                </div>
                ...
                <div class="bgf ">
                    <div class="pk-input">
                        ...
                        <nut-col :span="16" class="pk-foricon">
                            <div class="flex-content el-input">
                                <input class="inputs" type="text" placeholder="设置" v-model="user.nickname" />
                                <i><img :src="leftSrc"></i>
                            </div>
                        </nut-col>
                    </div>
                ...
                <div class="bgf ">
                    <div class="pk-input pad0 pk-sex">
                        <nut-cell class="pk-borth" :class="{ 'pk-sex-active': sexActive }" :isLink="true"
                            :showIcon="true" @click.native="switchPicker('isVisiblesex',2)">
                            <span slot="title">
                        ...
                        <nut-picker :is-visible="isVisiblesex" title="请选择性别" :list-data="sexList"
                            :default-value-data="defaultValueDatasex" @close="switchPicker('isVisiblesex')"
                            @confirm="setChooseValuesex"></nut-picker>
                    </div>
                </div>
                ...
                <div class="bgf ">
                    <div class="pk-input">
                        ...
                        <nut-col :span="16" class="pk-foricon">
                            <div class="flex-content el-input">
                                <input :disabled="idCardf != ''" class="inputs" type="text" placeholder="设置"
                                    v-model="user.idCard" />
                                <i><img :src="leftSrc"></i>
                            </div>
                        </nut-col>
                ...
                <div class="bgf ">
                    <div class="pk-input">
                        ...
                        <nut-col :span="16" class="pk-foricon">
                            <div class="flex-content el-input">
                                <input class="inputs" type="text" placeholder="设置" v-model="user.mobile" />
                                <i><img :src="leftSrc"></i>
                            </div>
                        </nut-col>
                    </div>
                ...
                <div class="bgf ">
                    <div class="pk-input">
                        ...
                        <nut-col :span="16" class="pk-foricon">
                            <div class="flex-content el-input">
                                <input class="inputs" type="text" placeholder="设置" v-model="user.email" />
                                <i><img :src="leftSrc"></i>
                            </div>
                        </nut-col>
                    </div>
                ...
                <div class="bgf ">
                    <div class="pk-input">
                        ...
                        <nut-col :span="16" class="pk-foricon">
                            <div class="flex-content el-input">
                                <input class="inputs" type="text" placeholder="设置" v-model="user.qq" />
                                <i><img :src="leftSrc"></i>
                            </div>
                        </nut-col>
                    </div>
                ...
                <div class="bgf ">
                    <div class="pk-input">
                        ...
                        <nut-col :span="16" class="pk-foricon">
                            <div class="flex-content el-input">
                                <input class="inputs" type="text" placeholder="设置" v-model="user.wechat" />
                                <i><img :src="leftSrc"></i>
                            </div>
                        </nut-col>
                    </div>
                ...
                <div class="bgf ">
                    <div class="pk-input pad0">
                        <nut-cell class="pk-borth" :class="{ 'pk-place-active': placeActive }" :isLink="true"
                            @click.native="switchPicker('isVisibles',1)" :showIcon="true">
                            <span slot="title">
                        ...
                        <nut-picker :is-visible="isVisibles" title="请选择城市" :list-data="andCountry"
                            :default-value-data="defaultValueData" @close="switchPicker('isVisibles')"
                            @confirm="setChooseValues" @choose="updateChooseValue"
                            @close-update="closeUpdateChooseValue"></nut-picker>
                    </div>
                </div>
                ...
                <div class="bgf ">
                    <div class="pk-input pad0 pk-day">
                        <!-- <label>生日</label> -->
                        <!-- <nut-col :span="16" class="pk-foricon"> -->
                        <nut-cell class="pk-borth" :class="{ 'pk-borth-active': borthActive }" :isLink="true"
                            :showIcon="true" @click.native="switchPicker('isVisible')">
                            <span slot="title">
                        ...
                        <nut-datepicker :is-visible="isVisible" type="date" title="请选择日期" :is-show-chinese="false"
                            startDate="1900-01-01" @close="switchPicker('isVisible')" @choose="setChooseValue">
                        </nut-datepicker>
                        <!-- </nut-col> -->
                    </div>
                </div>
                ...
                <div class="bgf ">
                    <div class="pk-input pk-signs">
                        ...
                        <nut-col :span="16" class="pk-foricon">
                            <div class="flex-content el-input">
                                <input class="inputs" type="text" placeholder="设置" v-model="user.personalSign" />
                                <i><img :src="leftSrc"></i>
                            </div>
                        </nut-col>
                    </div>
        ...
        <div class="btns">
            <nut-button block shape="circle" @click="updateUser">确定</nut-button>
        </div>
    ...
    methods: {
        ...
        hasPlace() {
            ...
            Object.keys(worldaddress.Earth.Country).map((v, i) => {
                ...
                Station.map((v2, i2) => {
                    var StationName =
                        worldaddress.Earth.Country[i].Station[i2].StationName;

                    if (!StationName) {
                        return;
                    }
                    arrStation.push(StationName);
                    var City = worldaddress.Earth.Country[i].Station[i2].City;
                    if (!City) return;
                    var cityArr = [];
        ...
        getUser() {
            getUserInfo().then(res => {
                if (res.success) {
                    ...
                    this.user.country =
                        this.user.country == 0 ? "请选择" : this.user.country;
                    this.user.province =
                        this.user.province == 0 ? "请选择" : this.user.province;
                    this.user.city =
                        this.user.city == "内网IP" ? "请选择" : this.user.city;
                    this.sex =
                        this.user.sex == 2
                            ? "女"
                            : this.user.sex == 1
        ...
        updateUser() {
            ...
            form.append("qq", this.user.qq);

            form.append("wechat", this.user.wechat);
            form.append("country", this.user.country);
            form.append("province", this.user.province);
            form.append("city", this.user.city);
            form.append("birthday", this.user.birthday);
            form.append("personalSign", this.user.personalSign);
        ...
        updateLinkage(self, value, index, chooseValue, cacheValueData) {
            ...
            switch (index) {
                case 1:
                    ...
                    this.andCountry.splice(index, 1, [
                        ...this.countryObj[this.andCountry[0][i]]
                    ]);
                    chooseValue = chooseValue
                        ? chooseValue
                        : this.andCountry[index][0];
                    self && self.updateChooseValue(self, index, chooseValue);
                    this.updateLinkage(
                        self,
                        chooseValue,
                        2,
                        cacheValueData && cacheValueData[2]
                            ? cacheValueData[2]
                            : null
                    );
                    break;
                case 2:
                    let areaData = this.countrySub[value]
                        ? this.countrySub[value]
                        : [];
