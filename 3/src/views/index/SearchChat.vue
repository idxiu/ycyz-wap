 ...
 * @LastEditTime: 2019-10-12 12:49:09
 * @LastEditors: Please set LastEditors
 -->
<template>
    <div class="pk-add-chat">
        <div class="pk-add-chat-box">
            <i class="iconfont iconicon_nav_back" @click="back()"></i>
        ...
        <div class="pk-def-list" v-if="!searchChat">
            ...
            <ul>
                <li v-for="(item,index) in list" :key="index" @click="toGame(item,1)">
                    ...
                    <p>{{item.gameName || item.productName}}</p>
                </li>
            </ul>
        </div>
        ...
        <money-conversion :date="new Date().getTime()" :productName="productName"
            :isShowTransInOrOut="isShowTransInOrOut" :apiTypeId="apiTypeId" :apiPlatform="apiPlatform" :apiId="apiId"
            @on-closeBox="isShowTransInOrOut=false"></money-conversion>
    </div>
</template>
<script>
