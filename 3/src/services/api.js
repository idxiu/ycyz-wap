 ...
 * @LastEditTime: 2019-10-09 17:34:50
 */
export default {
	//v3接口地址
	...
	UPD_USERINFO: "/member/update", //用户资料修改
	...
	GETPLANNED_INFOS: "/fc/bet/plans",//获取群-房间投注计划
	GETPLANNED_INFO: "/fc/bet/plan",//获取聊天室-房间投注计划
	POST_PLANNED_INFO:"fc/bet", // 跟投提交
	GET_NOTICES:'/groupChat/notices',//获取通知
	GET_NOTICE_DETAIL: "/getSysNoticeDetail", //公告通知-详情
